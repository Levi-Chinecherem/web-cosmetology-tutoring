"""
Django settings for cosmetology_tutoring project.
...
SECRET_KEY = 'django-insecure-&$gc#*1dvi9edii=j^p*+hay81t5tb8tqaz%md-!x(q=g28$*u'
...
INSTALLED_APPS = [
    ...
    # Your custom apps
    'home',  # Replace with your actual app names
    'account',
    'tutorials',
    'videos',
    'quizzes',
...
ROOT_URLCONF = 'cosmetology_tutoring.urls'
...
WSGI_APPLICATION = 'cosmetology_tutoring.wsgi.application'
